...
class ContactManager {
    ...
    public List<Contact> getAllSortedBy(Comparator<Contact> comp) {
        ...
        return contacts.stream().sorted(comp).collect(Collectors.toList());
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Maria: " + mgr.addContact(new Contact("Maria Torres", "maria@mail.com", "555-3333")));
        System.out.println("Ana duplicada: " + mgr.addContact(new Contact("Ana Garcia", "ana@mail.com", "555-9999")));
        System.out.println("Carlos: " + mgr.addContact(new Contact("Carlos Ruiz", "carlos@mail.com", "555-4444")));
        ...
        mgr.findByEmail("maria@mail.com")
                .ifPresentOrElse(c -> System.out.println("Encontrado: " + c), () -> System.out.println("No encontrado"));
